...
<h1>订单管理</h1>
<ul>
<li style="font-size:1.2em;"><s:a href="ShowOrder.action?order.orderState=1">待支付订单</s:a>
...
<li style="font-size:1.2em;font-weight:600;">已完成订单
</ul>
</div>
<div class="UserShowBox">
<s:if test="orders.size==0">
<p class="p">你没有交易完成的订单!</p>
</s:if>
<s:else>
<table border=1 class="OrderTable">
<tr>
<th>订单号</th><th>订单内容</th><th>总价</th><th>配送地址</th><th>操作</th>
</tr>
...
<td>
<s:a href="DelOrder.action?order.orderID=%{orderID}">删除</s:a>
</td>
</tr>
</s:iterator>
</table>
