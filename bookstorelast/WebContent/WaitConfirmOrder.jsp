...
<li style="font-size:1.2em;font-weight:600;">待收货订单
...
<td>
<s:a href="finish.action?order.orderID=%{orderID}">确认收货</s:a>
</td>
<td>
<s:a href="transport.jsp?id=%{kdNum}">查看物流</s:a>
</td>
</tr>
</s:iterator>
</table>
