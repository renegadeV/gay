...
<s:a href="AdminShowCustomer.action?customer.customerID=%{customer.customerID}&order.orderState=3">待收货订单</s:a>|
...
<tr><th>订单编号</th><th>订单内容<th>原价</th><th>应该支付</th><th>优惠活动</th></tr>
