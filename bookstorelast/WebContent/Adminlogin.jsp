...
<div class="loginbox">
	<h1 style="left:180px;">书城管理员登陆</h1>
<s:form action="AdminLogin.action" method="post">
<p style="position:absolute;top:83px;">管理员账号:</p><s:textfield name="admin.account" class="textfield" style="position:absolute;top:110px;left:235px;"/>
<p style="position:absolute;top:40%;">管理员密码:</p><s:password name="admin.password" class="textfield" style="position:absolute;top:188px;left:235px;"/>
