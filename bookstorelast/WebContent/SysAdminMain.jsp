...
<s:if test="#session['sysadmin']==null">
系统管理员未登录，请<s:a href="SysAdminlogin.jsp">登录</s:a>
</s:if>
<s:else>
<div class="adminMenu" style="top:118px;height:882px;">
<br>
<strong>系统管理员已登录</strong><br>
<s:a href="SysAdminLogout.action">注销登陆</s:a>

<s:include value="SysAdminMenu.jsp"></s:include>
</div>
</s:else>
</div>
</body>
