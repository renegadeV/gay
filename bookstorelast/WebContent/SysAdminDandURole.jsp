...
<td><s:a href="SysAdminDeleteRole.action?role.roleID=%{roleID}" onclick="return confirm('你确定要删除该记录吗？');">删除</s:a></td>
<td><s:a href="SysAdminUpdateRole.action?role.roleID=%{roleID}" >修改</s:a></td>
</s:iterator>
</table>
</div>
</body>
